						...
						onPressed: () async {
							if (PositionIndicator.getMostRecentPosition() == null) {
								...
								try {
									...
									double latitude = PositionIndicator
											.getMostRecentPosition()
											.latitude;
									double longitude = PositionIndicator
											.getMostRecentPosition()
											.longitude;
									...
									final path = join(
											...
											'${timestamp.year.toString()}-${timestamp.month.toString()}-${timestamp.day.toString()}-${timestamp.hour.toString()}-${timestamp.minute.toString()}-${timestamp.second
													.toString()}.jpg'
									);
